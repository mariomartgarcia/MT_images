...
def MT_band256(reg_sh = (256, 256, 3), pri_sh = (256, 256, 4)):
    unet_model = simple_unet256(input_shape = reg_sh)
    classifier_model = fcnn256(input_shape = pri_sh) 
...
def simple_unet256(input_shape=(256, 256, 3)):
    ...
    # Decoder
    up1 = layers.Conv2DTranspose(256, (3, 3), strides=(2, 2), padding="same", activation="relu")(pool4)
